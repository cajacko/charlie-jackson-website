...
exports.default = function () {
  if (isProjectLoop()) {
    getNextUrl((0, _jquery2.default)(document));
...
function getNextProjects(callback) {
  ...
  _jquery2.default.ajax({
    ...
    var response = (0, _jquery2.default)(data);
    var projects = (0, _jquery2.default)(response).find('.ProjectLoopItem');
    getNextUrl(response);
    callback(projects);
  });
}
...
function getNextUrl(context) {
  ...
  var nextUrl = (0, _jquery2.default)(context).find('.pagination .next').attr('href');
  var query = '?ajax=true';
...
function appendProjects(projectLoop, projects) {
  projects.each(function (i, project) {
    (0, _jquery2.default)(projectLoop).append(project);
  });
}
...
function fetchAndAppendNextProjects() {
  ...
  getNextProjects(function (projects) {
    var projectLoop = (0, _jquery2.default)('#Projects-loop');
...
function nearBottomTrigger(callback) {
  (0, _jquery2.default)(window).scroll(function () {
    var bottomHeight = (0, _jquery2.default)(document).height() - ((0, _jquery2.default)(window).scrollTop() + (0, _jquery2.default)(window).height());
...
function hidePagination() {
  (0, _jquery2.default)('.pagination').hide();
}

function isProjectLoop() {
  if ((0, _jquery2.default)('#Projects-loop')) {
    return true;
  }
...
},{"./components/Projects":1,"jquery":3}],3:[function(require,module,exports){
/*!
